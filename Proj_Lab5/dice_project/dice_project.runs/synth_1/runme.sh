...
HD_PWD='C:/Users/timim/OneDrive - FH JOANNEUM/1STM/Digital_Electronics/Lab5_Dice/Proj_Lab5/dice_project/dice_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dice_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dice_main.tcl
