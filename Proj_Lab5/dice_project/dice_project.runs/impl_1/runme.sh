...
HD_PWD='C:/Users/timim/OneDrive - FH JOANNEUM/1STM/Digital_Electronics/Lab5_Dice/Proj_Lab5/dice_project/dice_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dice_main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dice_main.tcl -notrace
